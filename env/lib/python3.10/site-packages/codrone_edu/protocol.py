...
class Count(ISerializable):
    ...
    def __init__(self):
        ...
        self.countTakeOff   = 0 # number of drone take offs
        self.countLanding   = 0 # number of landings of drone
        self.countAccident  = 0 # counts the number of accidents
...
class Bias(ISerializable):
    ...
    def __init__(self):
        self.accelX     = 0 # acceleration x axis
        self.accelY     = 0 # acceleration y axis
        self.accelZ     = 0 # acceleration z axis
        self.gyroRoll   = 0 # gyro x axis
        self.gyroPitch  = 0 # gyro y axis
        self.gyroYaw    = 0 # gyro z axis
